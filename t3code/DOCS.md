...
Add-on store → **⋮** → **Check for updates** → open **T3 Code** → **Update** or **Rebuild** → restart. Confirm version **0.3.5** in the log (`T3 Code add-on version 0.3.5`) and the **Pin matrix** lines for `t3` and `cursor-agent`.
